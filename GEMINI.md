...
- `browser-extension/`: Chrome and Firefox extensions for MangoFetch.
...
### Rust (Backend)
- **Shared Logic:** Always prioritize placing business logic, downloaders, and models in `mangofetch-core` so they are available to both CLI and GUI.
